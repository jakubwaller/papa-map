...
L = {
    "de": {
        ...
        "regions_h2_regions": "Bundesländer, Regionen und ganze Länder",
    ...
    "en": {
        ...
        "regions_h2_regions": "German states, regions and whole countries",
...
"""),
    ...
    "da": {
        ...
        "regions_h2_regions": "Tyske delstater, regioner og hele lande",
...
"""),
    ...
    "nl": {
        ...
        "regions_h2_regions": "Duitse deelstaten, regio's en hele landen",
...
"""),
    ...
    "fr": {
        ...
        "regions_h2_regions": "Bundesländer, régions et pays entiers",
...
"""),
    ...
    "it": {
        ...
        "regions_h2_regions": "Länder tedeschi, regioni e interi paesi",
...
"""),
    ...
    "cs": {
        ...
        "regions_note": ("<p>Stejný výpočet pro {n} Bundesländer a Dánsko "
                         "jako celek.</p>\n"),
        "regions_h2_regions": "Bundesländer, regiony a celé země",
...
"""),
    ...
    "pl": {
        ...
        "regions_note": ("<p>Ten sam rachunek dla {n} Bundesländer i całej "
                         "Danii.</p>\n"),
        "regions_h2_regions": "Niemieckie kraje związkowe, regiony i całe kraje",
...
"""),
    ...
    "sv": {
        ...
        "regions_h2_regions": "Tyska delstater, regioner och hela länder",
...
"""),
    ...
    "bs": {
        ...
        "regions_note": ("<p>Ista računica za {n} Bundesländer i Dansku u "
                         "cjelini.</p>\n"),
        "regions_h2_regions": "Njemačke pokrajine, regije i cijele zemlje",
...
"""),
    ...
    "ca": {
        ...
        "regions_h2_regions": "Bundesländer, regions i països sencers",
...
"""),
    ...
    "et": {
        ...
        "regions_h2_regions": "Bundesländer, piirkonnad ja terved riigid",
...
"""),
    ...
    "es": {
        ...
        "regions_h2_regions": "Estados alemanes, regiones y países enteros",
...
"""),
    ...
    "is": {
        ...
        "regions_h2_regions": "Þýsk sambandslönd, héruð og heil lönd",
...
"""),
    ...
    "lv": {
        ...
        "regions_note": ("<p>Tas pats aprēķins: {n} Bundesländer un Dānija "
                         "kopumā.</p>\n"),
        "regions_h2_regions": "Vācijas federālās zemes, reģioni un veselas valstis",
...
"""),
    ...
    "lt": {
        ...
        "regions_h2_regions": "Vokietijos žemės, regionai ir ištisos šalys",
...
"""),
    ...
    "hu": {
        ...
        "regions_h2_regions": "Német tartományok, régiók és egész országok",
...
"""),
    ...
    "no": {
        ...
        "regions_note": ("<p>Samme regnestykke for de {n} Bundesländer og "
                         "Danmark som helhet.</p>\n"),
        "regions_h2_regions": "Tyske delstater, regioner og hele land",
        "regions_note_regions": "<p>Samme regnestykke for {list}.</p>\n",
        "cl_lands": "de {n} Bundesländer",
        "cl_regions": "de {r} franske régions",
...
"""),
    ...
    "pt": {
        ...
        "regions_h2_regions": "Bundesländer, regiões e países inteiros",
...
"""),
    ...
    "ro": {
        ...
        "regions_h2_regions": "Landurile germane, regiuni și țări întregi",
...
"""),
    ...
    "sq": {
        ...
        "regions_h2_regions": "Shtetet federale gjermane, rajone dhe vende të tëra",
...
"""),
    ...
    "sk": {
        ...
        "regions_note": ("<p>Rovnaký výpočet pre {n} Bundesländer a pre "
                         "Dánsko ako celok.</p>\n"),
        "regions_h2_regions": "Nemecké spolkové krajiny, regióny a celé krajiny",
...
"""),
    ...
    "sl": {
        ...
        "regions_note": ("<p>Enak izračun za {n} Bundesländer in Dansko kot "
                         "celoto.</p>\n"),
        "regions_h2_regions": "Nemške dežele, regije in cele države",
...
"""),
    ...
    "fi": {
        ...
        "regions_note": ("<p>Sama laskutapa: {n} Bundesländer ja Tanska "
                         "kokonaisuutena.</p>\n"),
        "regions_h2_regions": "Saksan osavaltiot, alueet ja kokonaiset maat",
...
"""),
    ...
    "el": {
        ...
        "regions_h2_regions": "Γερμανικά κρατίδια, περιφέρειες και ολόκληρες χώρες",
...
"""),
    ...
    "be": {
        ...
        "regions_note": ("<p>Тыя ж падлікі для {n} Bundesländer і Даніі "
                         "цалкам.</p>\n"),
        "regions_h2_regions": "Нямецкія землі, рэгіёны і цэлыя краіны",
...
"""),
    ...
    "bg": {
        ...
        "regions_h2_regions": "Германски провинции, региони и цели държави",
...
"""),
    ...
    "mk": {
        ...
        "regions_h2_regions": "Германски покраини, региони и цели земји",
...
"""),
    ...
    "sr": {
        ...
        "regions_note": ("<p>Исти рачун за {n} Bundesländer и Данску у "
                         "целини.</p>\n"),
        "regions_h2_regions": "Немачке покрајине, региони и целе земље",
...
"""),
    ...
    "uk": {
        ...
        "regions_note": ("<p>Той самий підрахунок для {n} Bundesländer і "
                         "Данії в цілому.</p>\n"),
        "regions_h2_regions": "Німецькі землі, регіони і цілі країни",
