...
export const STRINGS = {
  ...
  no: {
    ...
    taglineMama: "Stellebord som en mamma når",
    ...
    statsLocalMama: '<b>{good}</b> stellebord i {area} kan du sannsynligvis bruke — for <b>{maybe}</b> er rommet ikke registrert. <span class="cta-grey">Trykk på de oransje nålene for å endre det.</span>',
