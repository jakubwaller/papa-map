...
export const STRINGS = {
  de: {
    ...
    roomBoth: "Damen- und Herren-WC",
    roomMale: "Herren-WC",
    roomFemale: "Damen-WC",
    roomUnisex: "Unisex-WC",
    roomDedicated: "Eigener Wickelraum",
    roomNone: "Kein Wickeltisch",
    askLoginHint: "Zum Antworten meldest du dich einmal mit deinem OSM-Konto an; die Antwort wird unter deinem Namen gespeichert.",
  ...
  en: {
    ...
    roomBoth: "Women's and men's rooms",
    roomMale: "Men's room",
    roomFemale: "Women's room",
    roomUnisex: "Unisex toilet",
    roomDedicated: "Separate changing room",
    roomNone: "No changing table",
    askLoginHint: "To answer, log in once with your OSM account; the answer is saved under your name.",
  ...
  da: {
    ...
    roomBoth: "Dame- og herretoilet",
    roomMale: "Herretoilet",
    roomFemale: "Dametoilet",
    roomUnisex: "Unisex-toilet",
    roomDedicated: "Eget puslerum",
    roomNone: "Intet puslebord",
    askLoginHint: "For at svare logger du ind én gang med din OSM-konto; svaret gemmes under dit navn.",
  ...
  nl: {
    ...
    roomBoth: "Dames- en herentoilet",
    roomMale: "Herentoilet",
    roomFemale: "Damestoilet",
    roomUnisex: "Unisextoilet",
    roomDedicated: "Aparte verschoonruimte",
    roomNone: "Geen verschoontafel",
    askLoginHint: "Om te antwoorden log je één keer in met je OSM-account; het antwoord wordt onder jouw naam opgeslagen.",
  ...
  fr: {
    ...
    roomBoth: "Toilettes femmes et hommes",
    roomMale: "Toilettes hommes",
    roomFemale: "Toilettes femmes",
    roomUnisex: "Toilettes mixtes",
    roomDedicated: "Espace à langer séparé",
    roomNone: "Pas de table à langer",
    askLoginHint: "Pour répondre, connecte-toi une fois avec ton compte OSM ; la réponse est enregistrée sous ton nom.",
  ...
  it: {
    ...
    roomBoth: "Bagno donne e bagno uomini",
    roomMale: "Bagno uomini",
    roomFemale: "Bagno donne",
    roomUnisex: "Bagno unisex",
    roomDedicated: "Stanza separata per il cambio",
    roomNone: "Nessun fasciatoio",
    askLoginHint: "Per rispondere accedi una volta con il tuo account OSM; la risposta viene salvata a tuo nome.",
  ...
  cs: {
    ...
    roomBoth: "Dámské i pánské WC",
    roomMale: "Pánské WC",
    roomFemale: "Dámské WC",
    roomUnisex: "Unisex WC",
    roomDedicated: "Samostatná přebalovací místnost",
    roomNone: "Žádný přebalovací pult",
    askLoginHint: "Pro odpověď se jednou přihlas svým účtem OSM; odpověď se uloží pod tvým jménem.",
  ...
  pl: {
    ...
    roomBoth: "Toaleta damska i męska",
    roomMale: "Toaleta męska",
    roomFemale: "Toaleta damska",
    roomUnisex: "Toaleta koedukacyjna",
    roomDedicated: "Osobne pomieszczenie do przewijania",
    roomNone: "Brak przewijaka",
    askLoginHint: "Aby odpowiedzieć, zaloguj się raz kontem OSM; odpowiedź zostanie zapisana pod Twoim nazwiskiem.",
  ...
  sv: {
    ...
    roomBoth: "Dam- och herrtoalett",
    roomMale: "Herrtoalett",
    roomFemale: "Damtoalett",
    roomUnisex: "Unisextoalett",
    roomDedicated: "Eget skötrum",
    roomNone: "Inget skötbord",
    askLoginHint: "För att svara loggar du in en gång med ditt OSM-konto; svaret sparas under ditt namn.",
  ...
  bs: {
    ...
    roomBoth: "Ženski i muški WC",
    roomMale: "Muški WC",
    roomFemale: "Ženski WC",
    roomUnisex: "Unisex WC",
    roomDedicated: "Zasebna prostorija za previjanje",
    roomNone: "Nema stola za previjanje",
    askLoginHint: "Da odgovoriš, prijavi se jednom svojim OSM nalogom; odgovor se sprema pod tvojim imenom.",
  ...
  ca: {
    ...
    roomBoth: "Lavabo de dones i d'homes",
    roomMale: "Lavabo d'homes",
    roomFemale: "Lavabo de dones",
    roomUnisex: "Lavabo unisex",
    roomDedicated: "Sala de canvi separada",
    roomNone: "Sense canviador",
    askLoginHint: "Per respondre, inicia sessió un cop amb el teu compte d'OSM; la resposta es desa amb el teu nom.",
  ...
  et: {
    ...
    roomBoth: "Naiste ja meeste WC",
    roomMale: "Meeste WC",
    roomFemale: "Naiste WC",
    roomUnisex: "Unisex-WC",
    roomDedicated: "Eraldi mähkimisruum",
    roomNone: "Mähkimislauda pole",
    askLoginHint: "Vastamiseks logi üks kord sisse oma OSM-i kontoga; vastus salvestatakse sinu nime all.",
  ...
  es: {
    ...
    roomBoth: "Baño de mujeres y de hombres",
    roomMale: "Baño de hombres",
    roomFemale: "Baño de mujeres",
    roomUnisex: "Baño unisex",
    roomDedicated: "Sala de cambio separada",
    roomNone: "Sin cambiador",
    askLoginHint: "Para responder, inicia sesión una vez con tu cuenta de OSM; la respuesta se guarda con tu nombre.",
  ...
  hr: {
    ...
    roomDedicated: "Zasebna prostorija za previjanje",
    roomNone: "Nema stola za previjanje",
    askLoginHint: "Za odgovor se jednom prijavi svojim OSM računom; odgovor se sprema pod tvojim imenom.",
    askAs: "Prijavljen kao {user}",
    askLogout: "Odjava",
    askSaving: "Spremam na OSM …",
  ...
  is: {
    ...
    roomBoth: "Kvenna- og karlasalerni",
    roomMale: "Karlasalerni",
    roomFemale: "Kvennasalerni",
    roomUnisex: "Sameiginlegt salerni",
    roomDedicated: "Sérstakt skiptiherbergi",
    roomNone: "Ekkert skiptiborð",
    askLoginHint: "Til að svara skráirðu þig einu sinni inn með OSM-reikningnum þínum; svarið er vistað undir þínu nafni.",
  ...
  lv: {
    ...
    roomBoth: "Sieviešu un vīriešu tualetē",
    roomMale: "Vīriešu tualetē",
    roomFemale: "Sieviešu tualetē",
    roomUnisex: "Kopējā tualetē",
    roomDedicated: "Atsevišķā pārtīšanas telpā",
    roomNone: "Nav pārtīšanas galda",
    askLoginHint: "Lai atbildētu, vienreiz pieslēdzies ar savu OSM kontu; atbilde tiks saglabāta ar tavu vārdu.",
  ...
  lt: {
    ...
    roomBoth: "Moterų ir vyrų tualete",
    roomMale: "Vyrų tualete",
    roomFemale: "Moterų tualete",
    roomUnisex: "Bendrame tualete",
    roomDedicated: "Atskiroje vystymo patalpoje",
    roomNone: "Nėra vystymo stalo",
    askLoginHint: "Norėdamas atsakyti, vieną kartą prisijunk su savo OSM paskyra; atsakymas bus išsaugotas tavo vardu.",
  ...
  hu: {
    ...
    roomBoth: "Női és férfi mosdó",
    roomMale: "Férfi mosdó",
    roomFemale: "Női mosdó",
    roomUnisex: "Uniszex mosdó",
    roomDedicated: "Külön pelenkázó",
    roomNone: "Nincs pelenkázóasztal",
    askLoginHint: "A válaszadáshoz jelentkezz be egyszer az OSM-fiókoddal; a válasz a te neved alatt kerül mentésre.",
  ...
  no: {
    ...
    roomBoth: "Dame- og herretoalett",
    roomMale: "Herretoalett",
    roomFemale: "Dametoalett",
    roomUnisex: "Unisextoalett",
    roomDedicated: "Eget stellerom",
    roomNone: "Ikke noe stellebord",
    askLoginHint: "For å svare logger du inn én gang med OSM-kontoen din; svaret lagres under navnet ditt.",
  ...
  pt: {
    ...
    roomBoth: "Casa de banho de senhoras e de homens",
    roomMale: "Casa de banho de homens",
    roomFemale: "Casa de banho de senhoras",
    roomUnisex: "Casa de banho mista",
    roomDedicated: "Sala de mudança separada",
    roomNone: "Sem fraldário",
    askLoginHint: "Para responder, inicia sessão uma vez com a tua conta OSM; a resposta fica guardada em teu nome.",
  ...
  ro: {
    ...
    roomBoth: "Toaleta femeilor și a bărbaților",
    roomMale: "Toaleta bărbaților",
    roomFemale: "Toaleta femeilor",
    roomUnisex: "Toaletă unisex",
    roomDedicated: "Cameră de înfășat separată",
    roomNone: "Fără masă de înfășat",
    askLoginHint: "Pentru a răspunde, conectează-te o dată cu contul tău OSM; răspunsul se salvează sub numele tău.",
  ...
  sq: {
    ...
    roomBoth: "Tualeti i grave dhe i burrave",
    roomMale: "Tualeti i burrave",
    roomFemale: "Tualeti i grave",
    roomUnisex: "Tualet i përbashkët",
    roomDedicated: "Dhomë e veçantë ndërrimi",
    roomNone: "Pa tavolinë ndërrimi",
    askLoginHint: "Për t'u përgjigjur, hyr një herë me llogarinë tënde OSM; përgjigjja ruhet nën emrin tënd.",
    askAs: "Hyrë si {user}",
    askLogout: "Dil",
  ...
  sk: {
    ...
    roomBoth: "Dámske aj pánske WC",
    roomMale: "Pánske WC",
    roomFemale: "Dámske WC",
    roomUnisex: "Unisex WC",
    roomDedicated: "Samostatná prebaľovacia miestnosť",
    roomNone: "Žiadny prebaľovací pult",
    askLoginHint: "Ak chceš odpovedať, prihlás sa raz svojím účtom OSM; odpoveď sa uloží pod tvojím menom.",
  ...
  sl: {
    ...
    roomBoth: "Ženski in moški WC",
    roomMale: "Moški WC",
    roomFemale: "Ženski WC",
    roomUnisex: "Unisex WC",
    roomDedicated: "Ločen previjalni prostor",
    roomNone: "Brez previjalne mize",
    askLoginHint: "Za odgovor se enkrat prijavi s svojim računom OSM; odgovor se shrani pod tvojim imenom.",
    ...
    roomBoth: "Naisten ja miesten wc",
    roomMale: "Miesten wc",
    roomFemale: "Naisten wc",
    roomUnisex: "Unisex-wc",
    roomDedicated: "Erillinen hoitohuone",
    roomNone: "Ei hoitopöytää",
    askLoginHint: "Vastataksesi kirjaudu kerran OSM-tililläsi; vastaus tallennetaan sinun nimissäsi.",
  ...
  el: {
    ...
    roomBoth: "Γυναικείες και ανδρικές τουαλέτες",
    roomMale: "Ανδρικές τουαλέτες",
    roomFemale: "Γυναικείες τουαλέτες",
    roomUnisex: "Κοινή τουαλέτα",
    roomDedicated: "Ξεχωριστός χώρος αλλαγής",
    roomNone: "Χωρίς αλλαξιέρα",
    askLoginHint: "Για να απαντήσεις, συνδέσου μία φορά με τον λογαριασμό σου στο OSM· η απάντηση αποθηκεύεται με το όνομά σου.",
  ...
  be: {
    ...
    roomBoth: "Жаночая і мужчынская прыбіральня",
    roomMale: "Мужчынская прыбіральня",
    roomFemale: "Жаночая прыбіральня",
    roomUnisex: "Агульная прыбіральня",
    roomDedicated: "Асобны пакой для спавівання",
    roomNone: "Няма стала для спавівання",
    askLoginHint: "Каб адказаць, увайдзіце адзін раз праз свой уліковы запіс OSM; адказ захаваецца пад вашым імем.",
  ...
  bg: {
    ...
    roomBoth: "Дамска и мъжка тоалетна",
    roomMale: "Мъжка тоалетна",
    roomFemale: "Дамска тоалетна",
    roomUnisex: "Обща тоалетна",
    roomDedicated: "Отделно помещение за повиване",
    roomNone: "Няма маса за повиване",
    askLoginHint: "За да отговориш, влез веднъж с OSM акаунта си; отговорът се записва под твоето име.",
  ...
  mk: {
    ...
    roomBoth: "Женски и машки тоалет",
    roomMale: "Машки тоалет",
    roomFemale: "Женски тоалет",
    roomUnisex: "Заеднички тоалет",
    roomDedicated: "Посебна просторија за пеленање",
    roomNone: "Нема маса за пеленање",
    askLoginHint: "За да одговориш, најави се еднаш со твојата OSM сметка; одговорот се зачувува под твоето име.",
  ...
  sr: {
    ...
    roomBoth: "Женски и мушки тоалет",
    roomMale: "Мушки тоалет",
    roomFemale: "Женски тоалет",
    roomUnisex: "Заједнички тоалет",
    roomDedicated: "Посебна просторија за превијање",
    roomNone: "Нема стола за превијање",
    askLoginHint: "Да би одговорио, пријави се једном својим OSM налогом; одговор се чува под твојим именом.",
  ...
  uk: {
    ...
    roomBoth: "Жіночий і чоловічий туалет",
    roomMale: "Чоловічий туалет",
    roomFemale: "Жіночий туалет",
    roomUnisex: "Спільний туалет",
    roomDedicated: "Окрема сповивальна кімната",
    roomNone: "Немає сповивального столика",
    askLoginHint: "Щоб відповісти, увійдіть один раз через свій обліковий запис OSM; відповідь збережеться під вашим іменем.",
  ...
  ja: {
    ...
    roomBoth: "女性用と男性用トイレの両方",
    roomMale: "男性用トイレ",
    roomFemale: "女性用トイレ",
    roomUnisex: "男女共用トイレ",
    roomDedicated: "専用のおむつ交換室",
    roomNone: "おむつ交換台なし",
    askLoginHint: "回答するには、OSMアカウントで一度ログインします。回答はあなたの名前で保存されます。",
    askAs: "{user} としてログイン中",
    askLogout: "ログアウト",
    askSaving: "OSMに保存中…",
